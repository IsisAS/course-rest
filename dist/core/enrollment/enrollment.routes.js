...
EnrollmentRoutes.post("/", auth_1.authenticateToken, EnrollmentController.create);
EnrollmentRoutes.post("/cancel", auth_1.authenticateToken, EnrollmentController.cancelEnrollment);
EnrollmentRoutes.post("/reactivate", auth_1.authenticateToken, EnrollmentController.reactivateEnrollment);
